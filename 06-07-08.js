...
function crearClasePersona() {
  class Persona {
    ...
    addFriend(nombre, edad) {
      ...
      // Tu código aca:
      let amigos= {nombre: nombre, edad: edad}
    ...
    getFriends() {
      ...
      for (let amigos of this.amigos){
        nombresDeAmigos.push(amigos.nombre)
    ...
    getPromedioEdad() {
      ...
      for(let i = 0; i < cantidadDeAmigos; i++) {
        susEdades += this.amigos[i].edad
        promedio = susEdades/cantidadDeAmigos;
      };return promedio;
